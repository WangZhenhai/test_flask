...
def ordermoney(web_url, goodsId, amount, mobile_number, password):
	url = web_url + "/login/check"
	payload = {'username': '', 'validateCode': '', 'messageCodeRegister': False, 'password': password}
	payload['username'] = str (mobile_number)
	headers = {'Content-Type': 'application/x-www-form-urlencoded',
...
def authindex(web_url, bus_order_no, period, amount):
	...
	with open (filepath + "buy.html", 'r+') as f:
		f.truncate ()
...
# 	token = ordermoney (web_url, '3680', '1000', '15316563887', '96e79218965eb72c92a549dd5a330112')
# 	print (token)
